...
```{r}
casas_bathrooms <- casas$bathrooms
...
```{r}
casas_sqft_living <- casas$sqft_living
...
# En el primer histograma podemos ver como los datos se agrupan de mayormente en 0, mientras que en el segundo si bien hay una tendencia a -1 todavia hay otros datos relevantes en 0.
```
...
zscore <- z_score(casas$bathrooms)
