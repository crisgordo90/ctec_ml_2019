...
Ejemplo
```{r}
cor(price.and.sqft_living, method='pearson')
cor(price.and.sqft_living, method='spearman')
```
...
Ejemplo
```{r}
plot(y = price.and.sqft_living$price,x = price.and.sqft_living$sqft_living, main = 'Relación entre Precio y Metros cuadrados', ylab = 'price', xlab = 'sqft_living')
```
